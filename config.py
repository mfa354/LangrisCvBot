...
OWNER_ID = 8023062532  # ganti dengan ID kamu
ADMIN_IDS = {
...
REQUIRED_CHANNEL = "@pudiditest2"
REQUIRED_GROUP   = "@pudiditest"
...
# MENUS
# - 'main' = Halaman 1
# - 'main_page2' = Halaman 2
# - Navigasi: ⬅️ (prev), 🏠 (home=halaman 1), ➡️ (next)
# =========================
MENUS = {
    # ========= MAIN (Page 1) =========
    'main': {
    ...
    try:
        if edit:
            if hasattr(message_target, "edit_message_text"):
                ...
                await message_target.edit_text(text, reply_markup=reply_markup, parse_mode='Markdown')
            else:
